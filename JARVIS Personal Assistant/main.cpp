...
----------------------------------------------------------------------------
               ...
               Made By         : Prashant Tyagi
               Written in      : C++
               Started project : 22 June , 2022
               Platform        : Windows
...
void check()
{
    if(m_word=="hi"||m_word=="hey"||m_word=="hello"||m_word=="hlo")
         {
            x.typing("Hi Prashant, how can I help you..");
         }
    ...
    else if (m_word=="play")
    {
      ...
      {
          x.speak("Sorry Prashant ,you does not enter song name");
         // tutorial("play");
      }
      else
        {
          ...
          {
            x.speak("Good bye, Prashant");
            Sleep(600);
            cout<<"\n\n\n\n\n\n\t\t\t\t\t";
            x.typing("Created By : Prashant Tyagi");
            Sleep(1500);
            exit(1);
          }
      ...
      else if(m_word=="what"||m_word=="who"||m_word=="how"||m_word=="when"||m_word=="where"||m_word=="why")
      {
          ...
          else if (input=="who are you"||input=="who created you"||input=="who made you")
          {
              ...
              Sleep(300);
              line();
              x.typing("Prashant Tyagi has made me.");
              Sleep(300);
              line();
              x.typing("I was created on 23 June ,2022");
              Sleep(300);
              line();
      ...
      /*else if(input=="unhide data"||input=="unhide data folder")
       ...
       {
         x.speak("Sorry Prashant, unknown comaand...");
         cnt++;
         if(cnt>=3)
         {  Sleep(600);
            x.speak("I think ");
...
Sleep(1000);
system("color c");
cout << setfill(' ') << setw(50) <<" Prashant Hacking Lab  \n";
Sleep(1000);
line();
